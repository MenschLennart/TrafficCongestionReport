...
namespace TrafficCongestionReport.UI
{
    public class OptionsKeymappingFunction : UICustomControl
    {
        ...
        public static readonly SavedInputKey amountMode = new SavedInputKey("AmountMode",
            "TrafficCongestionReport_SETTING", SavedInputKey.Encode(KeyCode.J, false, true, false), true);
        public static readonly SavedInputKey speedMode = new SavedInputKey("SpeedMode",
            "TrafficCongestionReport_SETTING", SavedInputKey.Encode(KeyCode.K, false, true, false), true);
        ...
        private void Awake()
        {
            AddKeymapping("AmountMode", amountMode);
            AddKeymapping("SpeedMode", speedMode);
        }
