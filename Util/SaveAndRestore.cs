...
namespace TrafficCongestionReport.Util
{
    public class SaveAndRestore : SerializableDataExtensionBase
    {
        ...
        public override void OnLoadData()
        {
            ...
            MainDataStore.saveData = SaveAndRestore._serializableData.LoadData("TrafficCongestionReport MainDataStore");
            if (MainDataStore.saveData == null)
            {
                DebugLog.LogToFileOnly("no TrafficCongestionReport MainDataStore save data, please check");
            }
            else
            {
                MainDataStore.load();
